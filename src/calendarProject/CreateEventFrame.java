...
public class CreateEventFrame extends JFrame{
	...
	public CreateEventFrame(LocalDate click, CalendarFrame cf, JButton date) {
		this.cf = cf;
		this.click = click;
		...
		for(JButton button: buttons) {
			button.addMouseListener(new MouseListener() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					cf.setDate();
					cf.getEventFrame().stateChanged(null);
	...
	public void setCloseReference(CreateEventFrame cef) {
		this.cef = cef;
	}
}
